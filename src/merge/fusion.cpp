...
std::size_t fusion_startup(FusionState& state,
    ...
    if (c0_on_c2) {
        ...
        // [C91 §3.1 Case 2]: "call the region of S₂ containing a₀
        // current."  No tie-breaking is needed here: the junction is
        // C₂'s start vertex (an endpoint), so §2.1 guarantees no NLC
